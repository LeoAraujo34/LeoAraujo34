...
Sou estudante de ADS e atualmente atuo como estagiário de TI.  
Tenho focado meus estudos no desenvolvimento web com PHP, praticando lógica de programação, formulários, validações e manipulação de dados.


Estou em constante evolução e construindo projetos para fortalecer minha base como desenvolvedor back-end.
Tenho total disponibilidade para aprender novas linguagens, tecnologias e processos conforme a necessidade do projeto.
